...
import com.footballmarket.service.IUserService;
import com.footballmarket.util.MD5Utils;
import com.footballmarket.util.RedisUtil;
import com.footballmarket.util.UUIDUtil;
...
public class UserController {
	...
	public String register(Users user){
		Users findUserByname = userService.findUserByname(user.getUserName());
		if(findUserByname != null){
			return"fail";
		}
		Users findUserByphone = userService.findUserByphone(user.getUserPhone());
