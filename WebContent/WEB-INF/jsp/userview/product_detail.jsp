	...
	<div class="container">
		<div class="row clearfix" >
			...
			<input  type="hidden" id="goodsId"
				...
				<h1 style="display: none;" class="text-center" >${requestScope.goods.goodsName }</h1>
			</div>
		</div>
		<div class="row clearfix" style="margin-bottom:50px;">
			...
			<div class="col-md-5 column" style="margin-top:10px;">
				<dl class="dl-horizontal">
				<h5><span style="color:#140a47;font-size:26px;font-weight:bold;">${requestScope.goods.goodsName}</span></h5>
				<hr  style="border:1px solid #140a47;"/>
					<h5>价&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp格：<span style="color:#140a47;font-size:22px;font-weight:bold;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp￥${requestScope.goods.goodsPrice}</span></h5>
					<h5>周边商品类型：<span style="color:#140a47;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp${requestScope.goods.goodsColor }</span></h5>
					<h5>周边商品规格：<span style="color:#140a47;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp${requestScope.goods.goodsMemory.memoryName }</span></h5>
					<h5 style="line-height: 30px;">周边商品描述：<span style="color:#140a47;font-size:16px">${requestScope.goods.goodsDesc}</span></h5>
					<h5 style="margin-top:40px">购买数量：
					<dd><div style="height: 38px;padding-left:10px;padding-top:5px;margin-top:-35px;margin-left:-40px">
		...
		<div>
				<div class="row clearfix">
					<h3 style="padding-left:30px;">周边商品评价</h3>
					<hr  style="border:1px solid #140a47;"/>
							         ...
							         <div>
							         	<c:if test="${e.imgList!=null }">
							         		<c:forEach items="${e.imgList }" var="g">
							         			<img src="upload/${g.evaimgName }" height="80px" width="100px" style="width:140px;height:140px;"/>
							         		</c:forEach>
							         	</c:if>
							         </div>
					          </c:forEach>
