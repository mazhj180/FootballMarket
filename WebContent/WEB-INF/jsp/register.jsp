...
<body>
			...
			<div class="layadmin-user-login layadmin-user-display-show" style="padding-top:30px;padding-bottom:30px;"
				...
				<div class="layadmin-user-login-main">
					...
					<div class="layadmin-user-login-box layadmin-user-login-body layui-form">
						<span style="color:red">*</span><div class="layui-form-item">
							<label
								class="layadmin-user-login-icon layui-icon layui-icon-username"
								for="LAY-user-login-nickname"></label> <input type="text"
								name="userName" id="LAY-user-login-nickname"
								lay-verify="required" placeholder="昵称" class="layui-input">
						</div>
						<span style="color:red">*</span><div class="layui-form-item">
							<label
						...
						<div class="layui-form-item" style="margin-top:40px;">
							<label
								class="layadmin-user-login-icon layui-icon layui-icon-cellphone" 
								for="LAY-user-login-email"></label> <input type="text" required="false" 
						...
						<div class="layui-form-item" style="height:50px;">
							...
							<div style="margin-top:10px;float:right"><a style="color:#029789;" href="view/xieyi">点此查看用户协议</a></div>
						</div>
	...
	function layuiformverify() {
		...
		layui.use(['form','layer'], function() {
			...
			layui.form.verify({
				pass:function(value){
			        if($('input[name=repass]').val() !== value)
			            return '提示：两次输入密码不一致！';
			    }
			});
			form.on('submit(reg-submit)',function(){
				$.post("user/register",$("#regForm").serialize(),function(data){
					if(data=="success"){
						...
						layer.msg("用户名或电话已存在！请重试！",{icon:5,anim:6,time:2000});
					}
				});
			});
		});
