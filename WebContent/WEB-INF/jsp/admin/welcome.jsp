...
<body style="background-color:#F2F2F2;padding-top:15px;padding-left:15px;padding-bottom:0px;">
	<div class="layui-card" style="width: 480px; margin-left:16px;height: 195px;float:left;">
		...
		<div class="layui-card-body" id="todo" style="width: 440px; height: 120px;">
              <div class="layadmin-backlog" lay-anim="" lay-indicator="inside" lay-arrow="none" style="width: 100%; height: 80px;">
                    ...
                    <li class="layui-col-xs6">
                    	<a class="layadmin-backlog-body" href="<%=basePath%>/view/orderlistbyfh">
	                        <h3>待发货</h3>
	...
	<div class="layui-card" style="width: 1200px; height: 595px;float:left;margin-left:15px;">
		 <div class="layui-card-header">热门周边商品浏览量</div>
		<div class="layui-card-body" id="hot" style="width: 1160px; height:580px;"></div>
	</div>
	<div class="layui-card" style="width: 480px; height: 310px;float:left;display:none;">
		<!-- <div class="layui-card-header">销售额及订单量趋势</div> -->
		<div class="layui-card-body" id="order" style="width: 480px; height: 260px;"></div>
	</div>
	<div class="layui-card" style="width: 1200px; height: 310px;float:left;margin-left:15px;">
		<div class="layui-card-header">周边商品销量排行</div>
		<div class="layui-card-body" id="volume" style="width: 1200px; height: 260px;"></div>
	</div>
</body>
