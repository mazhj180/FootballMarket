			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="goodsName" id="goodsName" required
						lay-verify="required" placeholder="请输入周边商品名称" value=""
						class="layui-input" />
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="goodsPrice" id="goodsPrice" required
						lay-verify="required" placeholder="请输入周边商品价格" value=""
						class="layui-input" />
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="goodsNum" id="goodsNum" required
						lay-verify="required" placeholder="请输入周边商品库存" value=""
						class="layui-input" />
				</div>
			</div>
	...
	$(function(){
					...
					form.on('submit(*)',function(){
						$.ajax({
							...
							success:function(data){
								if(data=="success"){
									layer.msg("添加周边商品成功！",{icon:1,time:2000},function(){
										window.location.href="view/goodsList";
									});
								}else{
									layer.msg("添加周边商品失败！请重试！",{icon:5,time:2000});
								}
							}
						});
						return false;
		...
		$.ajax({
         ...
         $.ajax({
   		   ...
   		   url: "memory/findAll",
   		   success: function(arr){
	            var str="<option value=''>请选择周边商品规格</option>";
	            for(var i=0;i<arr.length;i++){
