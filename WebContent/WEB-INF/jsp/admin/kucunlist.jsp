...
<div id="editForm" style="display:none;width:1200px;padding-top:10px;">
    <form id="formData" class="layui-form">
    	<input type="hidden" name="goodsId" id="goodsId" >
    	<div class="layui-form-item">
			    <label class="layui-form-label">周边商品名称</label>
			    <div class="layui-input-block">
			      <input type="text" name="goodsName" id="goodsName" required lay-verify="required" placeholder="请输入周边商品名称" value="" class="layui-input" />
			    </div>			    
		</div>
		<div class="layui-form-item" style="display:none;">
			    <label class="layui-form-label">周边商品价格</label>
			    <div class="layui-input-block">
			      <input type="text" name="goodsPrice" id="goodsPrice" required lay-verify="required" placeholder="请输入周边商品价格" value="" class="layui-input" />
			    </div>			    
		</div>
		<div class="layui-form-item">
			    <label class="layui-form-label">周边商品库存</label>
			    <div class="layui-input-block">
			      <input type="text" name="goodsNum" id="goodsNum" required lay-verify="required" placeholder="请输入周边商品库存" value="" class="layui-input" />
			    </div>			    
		</div>
		<div class="layui-form-item" lay-filter="test" style="display:none;">
			    <label class="layui-form-label">周边商品类别</label>
			    <div class="layui-input-inline">
		...
		<div class="layui-form-item" style="display:none;">
			    <label class="layui-form-label">周边商品规格</label>
			    <div class="layui-input-inline">
		...
		<div class="layui-form-item" style="display:none;">
			    <label class="layui-form-label">周边商品描述</label>
			    <div class="layui-input-block">
...
<script type="text/html" id="bar">
    <a class="layui-btn layui-btn-xs layui-btn-normal" title="设置库存" lay-event="edit">设置库存</a>
        ...
        layui.use(['layer', 'table','form','upload'], function ()
        {
            ...
            var tableIns = table.render({
                ...
                , cols: [[
                     ...
                     , { field: 'goodsName', title: '周边商品名称', width: 340, align: 'center' }
                    , { field: 'goodsPrice', title: '价格', width: 80,sort:true, align: 'center' }
                    , { field: 'goodsNum', title: '库存', width: 80,sort:true, align: 'center' }
                    , { field: 'goodsColor', title: '周边商品类型', width: 160, align: 'center' }
                    ,{field:'goodsType', title: '分类', width: 200 ,align: 'center',templet: function(d){
                        return d.goodsType.typeName
                   	}
                  }
                   ,{field:'memory', title: '规格', width: 80 ,align: 'center',templet: function(d){
                        return d.goodsMemory.memoryName
                   	}
                  }
                    ,{field:'goodsImg', title: '周边商品图片', width: 120 ,align: 'center',templet: function(d){
                          return '<img src="upload/'+d.goodsImg+'" />'
                     	}
                    }
                    , { field: 'goodsDesc', title: '周边商品描述', width: 360, align: 'center' }
            ...
            $("#delete").click(function ()
            {
                ...
                if (count > 0)
                {
                    parent.layer.confirm('确定要删除所选周边商品？', { icon: 3 }, function (index)
                    {
