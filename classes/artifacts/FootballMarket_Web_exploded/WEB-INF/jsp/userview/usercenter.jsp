...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			<!-- 控制栏 -->
			<div class="">
				<ul class="" style="margin-top:50px;margin-left:350px;">
					<li class="" style="display: block;padding-left:40px;background:#aaa; width:160px;float: left;"><a
						href="view/usercenter/#section1 "style="color:#fff;font-size:18px">收藏中心<span class="sr-only">(current)</span></a></li>
					<li class="list-group-item-diy" style="display: block;background:#aaa; width:160px;float: left;"><a
						href="view/usercenter/#section2"style="font-size:18px;color:#fff;">我的订单</a></li>
					<li class="list-group-item-diy" style="display: block;background:#aaa; width:160px;float: left;"><a
						href="view/usercenter/#section3"style="font-size:18px;color:#fff;">地址管理</a></li>
					<li class="list-group-item-diy" style="display: block;background:#aaa; width:160px;float: left;"><a
						href="view/usercenter/#section4"style="font-size:18px;color:#fff;">猜你喜欢</a></li>
					<li class="list-group-item-diy" style="display: block;background:#aaa; width:160px;float: left;"><a
						href="view/usercenter/#section5"style="font-size:18px;color:#fff;">账户安全</a></li>
				</ul>
			</div>
			<!-- 控制内容 -->
			<div class="main" style="margin-top:0px;">
				<div class="col-md-12">
					...
					<hr style="height:2px;border:none;border-top:1px solid #140a47;" />
...
<form id="addrFormData">
    ...
    <div class="layui-form-item">
	 ...
	 <div class="layui-form-item">
		...
		<div class="layui-input-inline">
			 <input type="text" onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" name="addrZipcode" id="addrZipcode" required lay-verify="required" placeholder="请输入邮政编码" value="" class="layui-input" />
		</div>			 
	</div>
	...
	<script type="text/javascript">
			...
			form.on('submit(setmypass)',function(data){
				$.ajax({
					...
					success:function(data){
						if(data=="success"){
							layer.alert('修改密码成功！请重新登录！', {icon: 1},function(index){
		...
		function showFavorite() {
			$.ajax({
						...
						success : function(arr) {
							var str = "<div style='' class='span16'><ul>";
		...
		function showRecentView() {
			$.ajax({
						...
						dataType : "json",
						success : function(arr) {
							var str = "<div style='padding-left:0px;' class='span16'><ul>";
							for (var i = 0; i < arr.length; i++) {
								if ((i + 1) % 4 != 0) {
									str = str
											+ "<li><a href='goods/detail?goodsId="
											...
											+ arr[i].guessGoods.goodsId
											+ ")' class='layui-btn layui-btn-sm layui-btn-normal' onclick='addToFavorite();'>收藏周边商品</button></li>";
								} else {
									str = str
											+ "<li class='brick4'><a href='goods/detail?goodsId="
											+ arr[i].guessGoods.goodsId
							...
							if (data == null ||data=="") {
								...
								for (var i = 0; i < data.length; i++) {
									...
									str = str
											...
											+ "<div class='layui-form'><table class='layui-table'><thead><tr><th>周边商品名称</th><th>价格</th><th>数量</th><th>小计</th></tr>"
											+ "</thead><tbody>";
						...
						success : function(data) {
							...
							if (data == null ||data=="") {
								...
								for (var i = 0; i < data.length; i++) {
									...
									var date1 = date.setHours(date.getHours() - date.getTimezoneOffset()/ 60) ;
