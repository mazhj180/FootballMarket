...
<body>
	...
	<div class="container-fluid" style="margin-top:50px;">
		<h3 class="title center">修改个人信息</h3>
		<br />
		<div style="width:700px;height:auto;margin:0 auto;">
			<form class="layui-form" action="user/updateUserInfo" method="post">
				...
				<div class="layui-form-item">
					<label class="layui-form-label">电&nbsp &nbsp话</label>
					<div class="layui-input-block">
				...
				<div class="layui-form-item">
					<label class="layui-form-label">邮&nbsp &nbsp箱</label>
					<div class="layui-input-block">
				...
				<div class="layui-form-item">
					<label class="layui-form-label">头&nbsp &nbsp像</label>
					<div class="layui-input-block">
