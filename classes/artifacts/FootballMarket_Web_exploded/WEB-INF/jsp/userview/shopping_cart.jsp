...
<body style="background: #fff;">
	...
	<!-- 中间内容 -->
	<div class="container-fluid bigHead" id="maincart" style="margin-top:50px;">
		<div class="row" style="background-color:white;">
			<div class="col-sm-10  col-md-10 col-sm-offset-1 col-md-offset-1">
				<div class="jumbotron">
					<h3>欢迎来到购物车</h3>
					<p>您的购物车快满了，赶紧清空购物车吧！</p>
				</div>
			</div>
			<div class="col-sm-10  col-md-10 col-sm-offset-1 col-md-offset-1">
...
<script type="text/javascript">
	...
	$(function(){
		$.ajax({
			...
			success : function(arr) {
				if(arr!=null&&arr!=""){
						var str='<tr>'+
						'<th>是否购买&nbsp<input onclick="selectAll();" type="checkbox" id="allSelect"></th>'+
						'<th>周边商品图</th>'+
						'<th>周边商品名称</th>'+
						'<th>周边商品单价</th>'+
						'<th>周边商品数量</th>'+
	...
	function confirmPre(){
		...
		if(num<1){
			layer.msg('请选择购买的周边商品！', { icon: 5, anim: 6 ,shade: 0.4, time: 1000 });
		}else{
			$("#cartForm").submit();
		}
	}
