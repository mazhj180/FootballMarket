...
<div class="layui-form-item" style="margin:15px;height:30px;">
	    ...
	    <div class="layui-input-inline" style="width:80px;">
	        <a class="layui-btn" id="search" data-type="reload" name="search">
	            <i class="layui-icon" id="sear"></i>搜索
	        </a>
	    </div> 
	    <div class="layui-input-inline" style="width:80px;">
...
<div id="formData" style="display:none;width:950px;padding-top:10px;">
	<form id="orderForm" class="layui-form">
		...
		<div class="layui-form-item">
			    ...
			    <div class="layui-input-block">
			      <input type="text" name="orderPrice" id="orderPrice" style='background-color:#F8F8F8;' required lay-verify="required" readonly="readonly" value="" class="layui-input" />
			    </div>			    
		</div>
		<div class="layui-form-item">
