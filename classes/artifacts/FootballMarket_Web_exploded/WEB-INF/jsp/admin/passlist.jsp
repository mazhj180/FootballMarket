	...
	<form class="layui-form" id="userForm">
		...
		<div class="layui-form-item" >
			    ...
			    <div class="layui-input-block">
			      <input type="text" name="userName" id="userName" readonly="readonly" style="background-color:#eee" lay-verify="required" value="" class="layui-input" />
			    </div>			    
		</div>
		...
		<div class="layui-form-item" >
			    ...
			    <div class="layui-input-block" >
			      <input type="text" name="userPass" id="userPass" readonly="readonly" style="background-color:#eee" lay-verify="required" value="123456" class="layui-input" />
			    </div>			    
		</div>
		<!-- <div class="layui-form-item">
...
<script type="text/html" id="bar">
    <a class="layui-btn layui-btn-xs layui-btn-normal" title="重置用户密码" lay-event="edit">重置用户密码</a>
                    ...
                    layer.open({
                        ...
                        yes: function(index, layero){
                        	$.post('user/updateUser',$('#userForm').serialize(),function(data){
                                if (data == 'success')
                                {
                                    parent.layer.msg('重置密码成功！', { icon: 1, shade: 0.4, time: 1000 });
                                    $("#search").click();
                                    $("#handle_status").val('');
                                }
                                else
                                {
                                    parent.layer.msg('重置密码失败！', { icon: 5, shade: 0.4, time: 1000 });
                                }
                                layer.close(index);
                                $("#newImg").html("");
                        	}); 
