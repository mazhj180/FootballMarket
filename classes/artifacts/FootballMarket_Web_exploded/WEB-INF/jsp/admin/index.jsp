...
<body class="layui-layout-body">
	<div class="layui-layout layui-layout-admin">
		<div class="layui-header">
			<div class="layui-logo">足球俱乐部周边销售平台</div>
			<!-- 头部区域（可配合layui已有的水平导航） -->
			<ul class="layui-nav layui-layout-left">
				<li class="layui-nav-item"><a href="view/welcome" target="myframe">返回首页</a></li>
				<li class="layui-nav-item"><a href="http://localhost:8080/FootballMarket/">返回前台</a></li>
			</ul>
			...
			<ul class="layui-nav layui-layout-right">
				...
				<li class="layui-nav-item"><a href="admin/logout">退出登录</a></li>
			</ul>
		</div>
		...
		<div class="layui-body">
			<!-- 内容主体区域 -->
			<iframe src="view/welcome" name="myframe" style="width:100%;height:100%;border: 0;" ></iframe>
		</div>
